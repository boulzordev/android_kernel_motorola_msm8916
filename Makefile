...
ARCH		?= arm
CROSS_COMPILE	?= /home/boulzorbuild/kernel/hyper-linaro-arm-eabi-5.1/bin/arm-eabi-
...
KERNELFLAGS	= -pipe -DNDEBUG -O3 -ffast-math -mtune=cortex-a53 -mcpu=cortex-a53 -marm -mfpu=neon-vfpv4 -ftree-vectorize -mvectorize-with-neon-quad -munaligned-access -fgcse-lm -fgcse-sm -fsingle-precision-constant -fforce-addr -fsched-spec-load
